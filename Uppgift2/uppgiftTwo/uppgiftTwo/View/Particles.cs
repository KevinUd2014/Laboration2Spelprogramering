...
namespace uppgiftTwo.View
{
    class Particles
    {
        ...
        {
            sb.Draw(texture, position, null, null, new Vector2(texture.Width / 2f, texture.Height / 2f), rotation, Vector2.One * scale * (age / maxAge), Color.White * (1 - (age / maxAge)), SpriteEffects.None, 0);
        }
